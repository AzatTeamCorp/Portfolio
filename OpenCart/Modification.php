...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
        ...
        if (isset($this->error['director'])) {
			$data['error_director'] = $this->error['director'];
		} else {
			$data['error_director'] = '';
		}
        ...
        if (isset($this->request->post['bik'])) {
			$data['bik'] = $this->request->post['bik'];
		} else {
			$data['bik'] = '';
		}
        ...
        if (isset($this->request->post['director'])) {
			$data['director'] = $this->request->post['director'];
		} else {
			$data['director'] = '';
		}
	...
	private function validate() {
        ...
        if (utf8_strlen($this->request->post['type'])==0) {
			$this->error['type'] = $this->language->get('error_type');
		}

        // if yur liso
        if ($this->request->post['type']=='2'){
            if (utf8_strlen($this->request->post['bin'])!=12) {
                $this->error['bin'] = $this->language->get('error_bin');
            }
            ...
            if (utf8_strlen($this->request->post['bik'])==0) {
                $this->error['bik'] = $this->language->get('error_bik');
            }

            if (utf8_strlen($this->request->post['bank'])==0) {
                $this->error['bank'] = $this->language->get('error_bank');
            }

            if (utf8_strlen($this->request->post['account_number'])==0) {
                $this->error['account_number'] = $this->language->get('error_account_number');
            }

            if (utf8_strlen($this->request->post['director'])==0) {
                $this->error['director'] = $this->language->get('error_director');
            }
        }
